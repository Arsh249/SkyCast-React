...
const Inputs = ({setQuery, setUnits}) => {
  ...
  //   setUnits(e.target.innerHTML);
  // }

  return (
    <div className="flex flex-row justify-center my-6">
    <div className="flex flex-row w-3/4 items-center justify-center space-x-4">
        <input value={city} onChange={(e) => setCity(e.target.value)} type="text" placeholder="Search by city..." className="text-gray-500 text-lg text-center font-light p-2  w-full shadow-xl capitalize focus:outline-none rounded-full placeholder:lowercase"/>
